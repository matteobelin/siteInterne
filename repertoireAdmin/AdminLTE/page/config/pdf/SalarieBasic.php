...
$requete =('SELECT salarie.nom as nom,salarie.prenom as prenom,agence.ville as ville,licence.nom as licence FROM salarie join agence on agence.id=salarie.id_agence left join licence on licence.id=salarie.id_licence where licence.nom="Basic" order by nom');
...
class PDF extends FPDF {
  ...
  $pdf->Cell(75,6,'Liste Salarie Basic',0,0,'L',1);    
