...
$requete =('SELECT salarie.nom as nom,salarie.prenom as prenom,agence.ville as ville,licence.nom as licence FROM salarie join agence on agence.id=salarie.id_agence left join licence on licence.id=salarie.id_licence where licence.nom="PROPLUS" order by nom');
...
class PDF extends FPDF {
  ...
  $pdf->Cell(75,6,'Liste Salarie Proplus',0,0,'L',1);    
...
mysqli_free_result($result);
    $pdf->Output('SalarieProplus.pdf','I');?>