...
$statement = $connexion->query('SELECT count(id) FROM demande WHERE resolu=0');//compte le nom d'id  des demande non resolu
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../../liste/listeOrdinateur.php?page=<?php echo $_SERVER['REQUEST_URI']?>" class="nav-link"><!--$_SERVER['REQUEST_URI'] permet de récuperer le lien de la page actuelle-->
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="insertDemande.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="nom">Nom</label>
                    <input type="text" id='nom' class="form-control" placeholder="Nom" name='nom' value="<?=$_GET['nom'] ??''?>">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" id='prenom' placeholder="Prenom" name='prenom' value="<?=$_GET['prenom'] ??''?>">
                    <?php if (isset($_GET['errors_prenom'])): ?> <!--gestion des erreurs-->
                        <div style="color:red;">
                  ...
                  <div class="form-group">
                    <label for="commentaire" style="padding-right :40em" class="form-label">Commentaire</label>
                    <textarea class="form-control" name="commentaire" id="commentaire" placeholder="Commentaire"  cols="30" rows="10"></textarea>
                    <?php if (isset($_GET['errors_commentaire'])): ?> <!--gestion des erreurs-->
                        <div style='color:red'>
                            <?php echo $_GET['errors_commentaire'].' *';?>
                        </div>
                    <?php endif?>
                  </div>
