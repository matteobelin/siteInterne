...
if(!empty($_POST['search'])){
    $query = $connexion->prepare('SELECT salarie.nom as nom,salarie.prenom as prenom,agence.ville as ville, licence.nom as licence FROM salarie join agence on agence.id=salarie.id_agence left join licence on licence.id=salarie.id_licence where licence.nom="PROPLUS" and (salarie.nom like :salarie_nom or salarie.prenom like :salarie_prenom or agence.ville like :ville) order by ville');        
...
<head>
  ...
  <title>Liste Salarié Proplus</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <?php if($_SESSION['admin']['accesDemande']==1):?><!-- affihce seulement si la personne a acces-->
      <li class="nav-item d-none d-sm-inline-block">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        ...
        <div class="navbar-search-block">
          <form class="form-inline" method="post"><!-- formulaire qui permet d'effectuer une recherche-->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="listeOrdinateur.php?page=<?php echo $_SERVER['REQUEST_URI']?>" class="nav-link"><!-- $_SERVER['REQUEST_URI'] récupere l'url de la page -->
          ...
          <li class="nav-item">
            <a href="../config/pdf/SalarieProplus.php" class="nav-link">
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Salarié Proplus</h1>
          </div><!-- /.col -->
    <!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
              ...
              <div class="card-body">
                <div id="actions" class="row">
                  ...
                  <form style="margin-left: 3em; " method="POST" action="listeSalarie.php" enctype="multipart/form-data"><!-- formulaire qui permet de trier par licence -->
                    
                          <select class="form-control select2bs4 m-4" style="width: 100%;" name="licence" id="licence">
                            <option value="liste<?php echo 'PROPLUS'?>.php"><?php echo 'PROPLUS'?></option>
                            <option value="liste<?php echo 'Salarie'?>.php"><?php echo 'Salarié'?></option>
                          <?php foreach($resultat as $result):?>   
                            <?php if($result['licence']!='PROPLUS' ):?>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <?php
                if(empty($_POST['search'])){//si pas de recherche effecté
                    $statement = $connexion->query('SELECT salarie.nom as nom,salarie.prenom as prenom,agence.ville as ville,licence.nom as licence FROM salarie join agence on agence.id=salarie.id_agence left join licence on licence.id=salarie.id_licence where licence.nom="PROPLUS" order by ville');
                    //recupere le nom,le prenom,la licence et l'agence du salarié
