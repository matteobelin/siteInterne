...
check_auth();// verifie si authentifier
if($_SESSION['admin']['accesImprimante']==0)://verifie si la personne a acces?>
    <script>alert("Vous n'avez pas acces a l'ajout d'imprimante")</script>
    <script>
        function RedirectionJavascript(){
            document.location.href="http://localhost/repertoireAdmin2/AdminLTE/page/profil/profil.php"; 
        }
    </script> 
    <body onLoad="setTimeout('RedirectionJavascript()', 750)"><!-- la fonction se lance 750 sec apres que l'alert a été accepté -->
...
$statement = $connexion->query('SELECT count(id) FROM demande WHERE resolu=0');// recupere le nombre dedemande non resolu
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
     <?php if($_SESSION['admin']['accesDemande']==1):?> <!-- affiche si la personne a acces aux demandes-->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../../../liste/listeOrdinateur.php?page=<?php echo $_SERVER['REQUEST_URI']?>" class="nav-link"><!-- $_SERVER['REQUEST_URI'] recup l'url de la page -->
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="insertImprimante.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="numero_serie">Numero de serie</label>
                    <input type="text" id='numero_serie' class="form-control" name='numero_serie' placeholder="Numero de serie" value="<?=$_GET['numero_serie'] ??''?>">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id='modele' class="form-control" name='modele' placeholder="Modele" value="<?=$_GET['modele'] ??''?>">
                    <?php if (isset($_GET['errors_modele'])): ?><!-- gestion des erreurs-->
                        <div style='color:red'>
                            <?php echo $_GET['errors_modele'] . ' *';?>
                        </div>
                            <?php endif?>
                  </div>
                  <div class="form-group">
                    <label for="ip">Adresse ip</label>
                    <input type="text" id='ip' class="form-control" placeholder="Adresse ip" name='ip' value="<?=$_GET['ip'] ??''?>">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id='marque' class="form-control" name='marque' placeholder="Marque" value="<?=$_GET['marque'] ??''?>">
