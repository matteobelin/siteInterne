...
if($_SESSION['admin']['accesImprimante']==0): //execute le reste si la persone n'a pas acces à l'imprimante?>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="modifierImprimanteForm.php" method="post">
                <div class="card-body">
