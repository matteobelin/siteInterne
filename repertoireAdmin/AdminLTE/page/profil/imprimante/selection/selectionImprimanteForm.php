...
check_auth();//verifie l'authentification de la personne
if($_SESSION['admin']['accesImprimante']==0)://execute si la personne n'a pas acces?>
    <script>alert("Vous n'avez pas acces a la sélection d'imprimante")</script>
    <script>
        function RedirectionJavascript(){
            document.location.href="http://localhost/repertoireAdmin2/AdminLTE/page/profil/profil.php"; 
        }
    </script> 
    <body onLoad="setTimeout('RedirectionJavascript()', 750)"><!-- attend 750sec avant de lancer la fonction -->
                <p style="font-size :30px; text-align : center ; font-weight: bold;margin-top : 12em">redirection ...</p>
    </body>
<?php else:?>
<?php
$connexion=connect_db();//connection a la base de donnée
$statement = $connexion->query('SELECT count(id) FROM demande WHERE resolu=0');//recupere le nombre de demande qui ne sont pas résolu
...
<head>
  ...
  <title>Selection Imprimante</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../../../liste/listeOrdinateur.php?page=<?php echo $_SERVER['REQUEST_URI']?>" class="nav-link"><!-- $_SERVER['REQUEST_URI'] permet de recuperer l'url de la page -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Selectionner une imprimante</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="selectionOrdinateur.php" method="post">
                <div class="card-body">
