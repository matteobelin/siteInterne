...
check_auth();
if($_SESSION['admin']['accesImprimante']==0):?>
    <script>alert("Vous n'avez pas acces a la suppression d'imprimante")</script>
    <script>
        function RedirectionJavascript(){
          document.location.href="http://localhost/repertoireAdmin/AdminLTE/index.php";
        }
    </script> 
...
<head>
  ...
  <title>Supprimer Imprimante</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Supprimer une imprimante</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="delImprimante.php" method="post">
                <div class="card-body">
                  ...
                  <label for="numero_serie">Numero de serie</label>
                    ...
                    <?php if (isset($_GET['errors_numero_serie'])): ?>
                        <div style="color : red">
