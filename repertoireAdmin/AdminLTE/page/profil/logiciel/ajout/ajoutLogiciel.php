...
if($_SESSION['admin']['accesLogiciel']==0)://execute si la personne n'a pas acces?>
    <script>alert("Vous n'avez pas acces a l'ajout de logiciel")</script>
    <script>
        function RedirectionJavascript(){
          document.location.href="http://localhost/repertoireAdmin2/AdminLTE/index.php";
        }
    </script> 
    <body onLoad="setTimeout('RedirectionJavascript()', 750)"><!-- execute la fonction 750sec apres la pop up fermé-->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../../../liste/listeOrdinateur.php?page=<?php echo $_SERVER['REQUEST_URI']?>" class="nav-link"><!-- $_SERVER['REQUEST_URI'] permet de recuperer l'url de cette page -->
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="insertLogiciel.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="nom">Nom du logiciel</label>
                    <input type="text" id='nom' class="form-control" placeholder="Nom du logiciel" name='nom' value="<?=$_GET['nom'] ??''?>">
