...
check_auth();//verifie que la personne est authentifier
if($_SESSION['admin']['accesLogiciel']==0)://execute si la peronne a l'acces?>
    ...
    <body onLoad="setTimeout('RedirectionJavascript()', 750)"><!-- execute apres 750sec la fonction-->
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="modifierLogicielForm.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="nom">Nom du logiciel</label>
                    <input class="form-control" type="text" id='nom' placeholder="Nom du logiciel" name='nom' value="<?=$_GET['nom'] ??''?>">
