...
if($_SESSION['admin']['accesLogiciel']==0)://execute si la personne n'a pas les droit?>
    ...
    <body onLoad="setTimeout('RedirectionJavascript()', 750)"><!-- execute apres 750 sec la fonction -->
...
$statement = $connexion->query('SELECT count(id) FROM demande WHERE resolu=0');//recup nombre demande non resolu
...
foreach($results as $result){
  $count=$result;
    ...
    $statement = $connexion->query('SELECT nom FROM logiciel');//recup nom des logiciels
    $results = $statement->fetchAll(PDO::FETCH_ASSOC);
  $total=0;

  if(!empty($_GET['nom'] )){
    $_SESSION['admin']['logiciel']=$_GET['nom'];
}
if(!empty($_POST['nom'])){
    $_SESSION['admin']['logiciel']=$_POST['nom'];
  }

  foreach($results as $nom){
      if($_SESSION['admin']['logiciel']==$nom['nom'])//verifie si le logiciel existe
      $total+=1;
  }
  ...
  if(empty( $_SESSION['admin']['logiciel'])){
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <?php if($_SESSION['admin']['accesDemande']==1)://affiche si la personne a acces?> 
      <li class="nav-item d-none d-sm-inline-block">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../../../liste/listeOrdinateur.php?page=<?php echo $_SERVER['REQUEST_URI']?>" class="nav-link"><!-- $_SERVER['REQUEST_URI'] permet de recuperer l'url de la page actuelle -->
          ...
          <li class="nav-item">
            <a href="modifierLogiciel.php" class="nav-link">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="updateLogiciel.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="nom" >Nom</label>
                    <input type="text" id='nom' class="form-control" name='nom' placeholder="Nom" value="<?=$_SESSION['admin']['logiciel'] ??''?>" readonly>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id='nouveauNom' class="form-control" name='nouveauNom' value="<?=$_GET['nouveauNom'] ??''?>">
                    <?php if (isset($_GET['errors_nouveauNom']))://gestion des erreurs ?>
                        <div style='color : red'>
                        <?php echo $_GET['errors_nouveauNom'].' *';?>
                        </div>
                    <?php endif?>
                  </div>
