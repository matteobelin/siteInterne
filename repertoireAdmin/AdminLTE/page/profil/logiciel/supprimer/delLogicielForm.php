...
if($_SESSION['admin']['accesLogiciel']==0)://execute si la personne n'a pas acces ?>
    <script>alert("Vous n'avez pas acces a la suppression de logiciel")</script>
    <script>
...
<head>
  ...
  <title>Supprimer Logiciel</title>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="delLogiciel.php" method="post">
                <div class="card-body">
