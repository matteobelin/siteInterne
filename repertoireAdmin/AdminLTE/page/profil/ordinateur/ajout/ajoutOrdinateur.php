...
if($_SESSION['admin']['accesOrdi']==0)://execute si la personne n'a pas acces?>
    <script>alert("Vous n'avez pas acces a l'ajout d'ordinateur")</script>
    <script>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../../../liste/listeOrdinateur.php?page=<?php echo $_SERVER['REQUEST_URI']?>" class="nav-link"><!-- $_SERVER['REQUEST_URI'] permet de recup l'url de la page-->
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="insertOrdinateur.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                  <label for="numero_serie">Numero de serie</label>
                    <input class="form-control" type="text" placeholder="Numero de série" id='numero_serie' name='numero_serie' value="<?=$_GET['numero_serie'] ??''?>">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" id='nom' name='nom' placeholder="Nom" value="<?=$_GET['nom'] ??''?>">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="code_compta" id="code_compta">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" id='designation' name='designation' placeholder="Désignation" value="<?=$_GET['designation'] ??''?>">
                    <?php if (isset($_GET['errors_designation'])): //gestion des erreurs?>
                        <div style="color : red">
                            <?php echo $_GET['errors_designation'].' *';?>
                        </div>
                    <?php endif?>
                  </div>
                  <div class="form-group">
                  <label for="marque">Marque</label>
                    <input class="form-control" type="text" id='marque' name='marque' placeholder="Marque" value="<?=$_GET['marque'] ??''?>">
