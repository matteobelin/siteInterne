...
if($_SESSION['admin']['accesOrdi']==0)://execute si la personne n a pas acces?>
    <script>alert("Vous n'avez pas acces a la sélection d'ordinateur")</script>
    <script>
        function RedirectionJavascript(){
            document.location.href="http://localhost/repertoireAdmin2/AdminLTE/page/profil/profil.php"; 
        }
    </script> 
    <body onLoad="setTimeout('RedirectionJavascript()', 750)"><!--execute la fonction apres 750sec -->
...
<head>
  ...
  <title>Selection Ordinateur</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Selectionner un ordinateur</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
