...
if($_SESSION['admin']['accesOrdi']==0)://execute si la personne n'a pas acces?>
    <script>alert("Vous n'avez pas acces a la suppression d'ordinateur")</script>
    <script>
        function RedirectionJavascript(){
          document.location.href="http://localhost/repertoireAdmin2/AdminLTE/index.php"; 
        }
    </script> 
    <body onLoad="setTimeout('RedirectionJavascript()', 750)"><!-- execute la fonction apres750 sec -->
...
<head>
  ...
  <title>Supprimer Ordinateur</title>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="delOrdinateur.php" method="post">
                <div class="card-body">
