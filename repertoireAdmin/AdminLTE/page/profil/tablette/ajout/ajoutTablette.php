...
if($_SESSION['admin']['accesTablette']==0)://execute si pas access?>
    <script>alert("Vous n'avez pas acces a l'ajout de tablette")</script>
    <script>
...
<?php else:?>
<?php
$connexion=connect_db();//connection  a la base de donnee
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <?php if($_SESSION['admin']['accesDemande']==1)://affiche si acces?> 
      <li class="nav-item d-none d-sm-inline-block">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="insertTablette.php" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select name="code_compta" class="form-control" id="code_compta">
                        <option value="1">Tablette</option>
                    </select>
                  </div>
                  <div class="form-group">
