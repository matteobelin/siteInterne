...
if($_SESSION['admin']['accesTablette']==0)://si pas acces?>
    <script>alert("Vous n'avez pas acces a la sélection de tablette")</script>
    <script>
...
$statement = $connexion->query('SELECT count(id) FROM demande WHERE resolu=0');//demande non resolu
...
<head>
  ...
  <title>Selection Tablette</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Selectionner une tablette</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="selectionTablette.php" method="post">
                <div class="card-body">
