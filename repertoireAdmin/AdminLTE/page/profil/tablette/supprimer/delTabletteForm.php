...
check_auth();//verif l'auth
if($_SESSION['admin']['accesTablette']==0)://si pas acces?>
    <script>alert("Vous n'avez pas acces a la suppresion de tablette")</script>
    <script>
...
<head>
  ...
  <title>Supprimer Tablette</title>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="delTablette.php" method="post">
                <div class="card-body">
