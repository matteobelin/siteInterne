...
if($_SESSION['admin']['accesTelephone']==0)://pas acces?>
    <script>alert("Vous n'avez pas acces a l'ajout de téléphone")</script>
    <script>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="insertTelephone.php" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id='type' class="form-control" name='type' placeholder="Type" value="<?=$_GET['type'] ??''?>">
                  ...
                  <div class="form-group">
                    ...
                    <select name="code_compta" class="form-control" id="code_compta">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id='numero_telephone' class="form-control" placeholder="Numero de telephone" name='numero_telephone' value="<?=$_GET['numero_telephone'] ??''?>">
                    <?php if (isset($_GET['errors_numero_telephone']))://gestion des erreurs ?>
                        <div style='color:red'>
                            <?php echo $_GET['errors_numero_telephone'].' *';?>
                        </div>
                    <?php endif?>
                  </div>
                  <div class="form-group">
                    <label for="numero_carte">Numero de carte</label>
                    <input type="text" id='numero_carte' class="form-control" name='numero_carte' placeholder="Numero de carte" value="<?=$_GET['numero_carte'] ??''?>">
                    <?php if (isset($_GET['errors_numero_carte']))://gestion des erreurs ?>
                        <div style='color:red'>
                            <?php echo $_GET['errors_numero_carte'].' *';?>
                        </div>
                    <?php endif?>
                  </div>
