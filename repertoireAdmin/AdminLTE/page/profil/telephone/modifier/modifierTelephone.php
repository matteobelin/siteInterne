...
if($_SESSION['admin']['accesTelephone']==0)://execute si pas acces?>
...
$statement = $connexion->query('SELECT count(id) FROM demande WHERE resolu=0');//recupe nb de demande non enregistrer
...
<head>
  ...
  <title>Modifier Téléphone</title>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="modifierTelephoneForm.php" method="post">
                <div class="card-body">
