...
if($_SESSION['admin']['accesTelephone']==0)://si pas acces?>
    <script>alert("Vous n'avez pas acces a la sélection de téléphone")</script>
    <script>
...
<head>
  ...
  <title>Selection Téléphone</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Selectionner un téléphone</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="selectionTelephone.php" method="post">
                <div class="card-body">
