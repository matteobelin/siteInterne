...
if($_SESSION['admin']['accesTelephone']==0)://si pas acces?>
    <script>alert("Vous n'avez pas acces a la suppression de téléphone")</script>
    <script>
...
<head>
  ...
  <title>Supprimer Téléphone</title>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="delTelephone.php" method="post">
                <div class="card-body">
