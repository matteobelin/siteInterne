...
if($_SESSION['admin']['accesSalarie']==0):?>
    <script>alert("Vous n'avez pas acces a l'ajout de salarié")</script>
    <script>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="insertSalarie.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="nom">Nom</label>
                    <input class="form-control" type="text" id='nom' placeholder="Nom" name='nom' value="<?=$_GET['nom'] ??''?>">
                  ...
                  <div class="form-group">
                  <label  class="form-label" for="licence">Licence Microsoft</label>
